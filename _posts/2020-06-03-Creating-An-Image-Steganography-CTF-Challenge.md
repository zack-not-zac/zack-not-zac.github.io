...
For Securi-Tay 2020 the committee decided to host a penguin-themed CTF featuring challenges made by current and former students. I decided to create an easily accessible challenge, allowing people to get to grips with the CTF format using a relatively simple challenge. This challenge featured a combination of simple network forensics and image steganography, and if you'd like to give it a go all you have to do is download [this PCAP file]({{site.url}}/files/Securi-Tay-Challenge.pcapng) to get started.
